      ...
      <section className=" justify-center items-center flex lg:min-h-screen p-8 bg-white bg-cover bg-right lg:bg-top lg:bg-cover bg-[url('/blossomsv2.png')] lg:bg-[url('/blissv2.png')]" >
        <div className=" text-center text-black max-w-7xl">
          <div className='mx-auto overflow-auto rounded-2xl bg-orange-400/70 h-max p-5 my-auto grid'>
            <h1 className=' text-3xl mb-4' id="test"> <span className='text-5xl playwrite-no-100'>Blossoms And Bliss:</span><br/> An Evening Blooming with Elegance and Joy</h1>
            <h1 className=' text-3xl my-1' id="test"> Alexus Birthday Celebration</h1>
